...
function formatSup(elem, options) {
  if (options.ignoreSup) {
    return '';
  }
  return formatText(elem, options);
}

function formatSub(elem, options) {
  if (options.ignoreSub) {
    return '';
  }
  return formatText(elem, options);
}
...
exports.sup = formatSup;
exports.sub = formatSub;